...
import com.example.myapplication.databinding.ActivityRecentPlayBinding
...
import com.example.myapplication.viewmodel.RecentPlayViewModel
...
class RecentPlayActivity : BaseActivity<ActivityRecentPlayBinding>() {
    ...
    override fun initBinding() = ActivityRecentPlayBinding.inflate(layoutInflater)
